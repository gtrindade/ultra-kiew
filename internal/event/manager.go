...
const (
	...
	// updateStatusAction records one person's answer to an invite. A constant
	// rather than a literal repeated in the dispatch switch and the schema
	// enum, so those two cannot drift apart.
